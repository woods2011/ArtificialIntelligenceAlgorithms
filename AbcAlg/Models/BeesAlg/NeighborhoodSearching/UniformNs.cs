...
{
    public class UniformNs : NeighborhoodSearchingAlg
    {
        public UniformNs((double a, double b) x1Bounds, (double a, double b) x2Bounds,
        ...
        public override List<FoodSource> Search(IList<FoodSource> currentPopulation)
        {
            return currentPopulation.Select(origFoodSource =>
            {
                ...
                {
                    case 1:
                        changedFoodSource.X1 = ContinuousUniform.Sample(Random, X1Bounds.a, X1Bounds.b);
                        break;
                    case 2:
                        changedFoodSource.X2 = ContinuousUniform.Sample(Random, X2Bounds.a, X2Bounds.b);
                        break;
            ...
            //     {
            //         case 1:
            //             var newX1 = Math.Clamp(ContinuousUniform.Sample(Random, X1Bounds.a, X1Bounds.b),
            ...
            //
            //         case 2:
            //             var newX2 = Math.Clamp(ContinuousUniform.Sample(Random, X2Bounds.a, X2Bounds.b),
